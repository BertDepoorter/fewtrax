...
PARAM_SUITE = [
    ...
    dict(label="mid-spin",     M=1e6, mu=10.0, a=0.3,  p0=10.0, e0=0.4,  x0=1.0,
         dist=1.0, qS=0.2, phiS=0.2, qK=0.8, phiK=0.8,
         Phi_phi0=1.0, Phi_theta0=2.0, Phi_r0=3.0, T=0.1, dt=10.0),
    dict(label="high-spin",    M=1e6, mu=10.0, a=0.7,  p0=9.0,  e0=0.3,  x0=1.0,
         dist=1.0, qS=0.5, phiS=1.0, qK=0.5, phiK=1.0,
         Phi_phi0=0.0, Phi_theta0=0.0, Phi_r0=0.0, T=0.1, dt=10.0),
    dict(label="near-extreme", M=1e6, mu=10.0, a=0.9,  p0=8.0,  e0=0.2,  x0=1.0,
         dist=1.0, qS=0.3, phiS=0.5, qK=0.3, phiK=0.5,
         Phi_phi0=0.0, Phi_theta0=0.0, Phi_r0=0.0, T=0.05, dt=10.0),
    dict(label="high-ecc",     M=1e6, mu=10.0, a=0.5,  p0=12.0, e0=0.6,  x0=1.0,
         dist=1.0, qS=0.4, phiS=1.5, qK=0.4, phiK=1.5,
         Phi_phi0=0.0, Phi_theta0=0.0, Phi_r0=0.0, T=0.1, dt=10.0),
    dict(label="low-ecc",      M=1e6, mu=10.0, a=0.3,  p0=11.0, e0=0.05, x0=1.0,
         dist=1.0, qS=0.2, phiS=0.2, qK=0.8, phiK=0.8,
         Phi_phi0=0.0, Phi_theta0=0.0, Phi_r0=0.0, T=0.1, dt=10.0),
